            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-7">
                        ...
                        <!-- form kelas -->
                        <?= form_open_multipart('admin/ubah_tema?ktm=' . $this->input->get('ktm', TRUE)); ?>
                        <div class="form-group">
                            <label for="nama_tema" class="text-gray-800">Nama tema</label>
                            <input type="text" class="form-control" id="nama_tema" name="nama_tema" placeholder="Masukkan nama tema" value="<?= $tema['nama_tema']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <img src="<?= base_url('layout/img/tema/' . $tema['url']); ?>" class="img-thumbnail img-preview mt-3" style="max-width: 200px;">
                        </div>
