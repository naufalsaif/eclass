    ...
    <div class="col">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-light pl-0 py-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tambah Avatar</li>
            </ol>
        </nav>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-7">
                        ...
                        <!-- form kelas -->
                        <?= form_open_multipart('admin/tambah_avatar'); ?>
                        <div class="form-group">
                            <label for="nama_avatar" class="text-gray-800">Nama avatar</label>
                            <input type="text" class="form-control" id="nama_avatar" name="nama_avatar" placeholder="Masukkan nama avatar" value="<?= set_value('nama_avatar'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                ...
                                <?php if (!form_error('url')) : ?>
                                    <small class="form-text text-muted">Upload gambar hanya bisa png, jpg, jpeg. jika melebihi 1mb resize <a href="https://squoosh.app/" class="text-primary" target="_blank"><strong>disini</strong></a> atau cari avatar lain <a href="https://illlustrations.co/" class="text-primary" target="_blank"><strong>disini</strong></a></small>
                                <?php endif; ?>
