        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block"><img src="<?= base_url('layout/img/ilustrasi/my_password.png'); ?>" alt="Illustrations" class="img-fluid gambar-ukuran"></div>
                        <div class="col-lg-6 form-ukuran">
                            <div class="p-5">
                                ...
                                <form class="user" action="<?= base_url('auth/reset_password?email=' . urlencode($this->input->get('email', TRUE)) . '&token=' . urlencode($this->input->get('token', TRUE))); ?>" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-user btn-block mt-4">Simpan</button>
                                </form>
                                <hr class="mt-4">
                                <div class="text-center">
