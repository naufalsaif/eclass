        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block"><img src="<?= base_url('layout/img/ilustrasi/active_support.png'); ?>" alt="Illustrations" class="img-fluid gambar-ukuran"></div>
                        <div class="col-lg-6 form-ukuran">
                            <div class="p-5">
                                <div class="text-center">
                                    <div class="h2 text-gray-900 mb-4"><b>KELAS<sup style="font-size: 20px;">KU</sup></b></div>
                                    <hr class="mb-4">
                                    <h1 class="h4 text-gray-900 mb-4">Bantu Saya</h1>
                                </div>
                                ...
                                <form class="user" action="<?= base_url('auth/bantu'); ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="keluhan" name="keluhan" placeholder="Masukkan tanggal_lahir anda">
                                            <option selected disabled>-- Pilih Keluhan --</option>
                                            <option value="blokir" <?= (set_value('keluhan') == 'blokir' ? 'selected' : ''); ?>>Buka blokir</option>
                                            <option value="aktivasi" <?= (set_value('keluhan') == 'aktivasi' ? 'selected' : ''); ?>>Minta aktivasi</option>
                                        </select>
