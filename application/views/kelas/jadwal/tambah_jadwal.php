        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-7">
                            <form action="<?= base_url('kelas/tambah_jadwal') . '?kk=' . $this->input->get('kk', TRUE); ?>" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="hari" name="hari">
                                        ...
                                        <option value="jumat" <?= (set_value('hari') == 'jumat' ? 'selected' : ''); ?>>jumat</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" id="jam_selesai" name="jam_selesai" value="<?= set_value('jam_selesai'); ?>">
                        ...
                        <div class="col-lg-5 mt-4">
                            <img src="<?= base_url('layout') . '/img/ilustrasi/jadwal.png'; ?>" alt="Illustrations" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
