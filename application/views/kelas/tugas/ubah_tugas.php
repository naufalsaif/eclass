    ...
    <div class="col">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-light pl-0 py-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Ubah Tugas</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-7">
                        <form action="<?= base_url('kelas/ubah_tugas') . '?kk=' . $this->input->get('kk', TRUE) . '&kt=' . $this->input->get('kt', TRUE); ?>" method="POST">
                            <div class="form-group">
                                <label for="nama_tugas">Nama tugas</label>
                                <input type="text" class="form-control" id="nama_tugas" name="nama_tugas" placeholder="Masukkan nama tugas" value="<?= $tugas['nama_tugas']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="kode_guru" name="kode_guru">
                                    <?php foreach ($guru as $g) : ?>
                                        <option value="<?= $g['kode_guru']; ?>" <?= ($tugas['kode_guru'] == $g['kode_guru'] ? 'selected' : ''); ?>><?= substr_table($g['nama_guru'] . ' - ' . $g['mata_pelajaran']); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="deskripsi_tugas" name="deskripsi_tugas" rows="3"><?= $tugas['deskripsi_tugas']; ?></textarea>
                                <?= form_error('deskripsi_tugas', '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="batas_pengumpulan">Batas pengumpulan</label>
                                <input type="datetime-local" class="form-control" id="batas_pengumpulan" name="batas_pengumpulan" value="<?= strftime('%Y-%m-%dT%H:%M', strtotime($tugas['batas_pengumpulan'])); ?>">
                                <?= form_error('batas_pengumpulan', '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="link_pengumpulan">Link pengumpulan(Opsional)</label>
                                <input type="text" class="form-control" id="link_pengumpulan" name="link_pengumpulan" placeholder="Masukkan link pengumpulan jika ada" value="<?= $tugas['link_pengumpulan']; ?>">
