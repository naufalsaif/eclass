    ...
    <div class="col">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-light pl-0 py-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Ubah Ruangan Absen</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-7">
                        <form action="<?= base_url('kelas/ubah_ruangan_absen') . '?kk=' . $this->input->get('kk', TRUE) . '&ka=' . $this->input->get('ka', TRUE); ?>" method="POST">
                            <fieldset class="form-group row">
                                <legend class="col-form-label col-sm-2 float-sm-left pt-0">Status</legend>
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="status2" value="hadir" <?= ($anggota_absen['status'] == 'hadir' ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="status2">
                                            Hadir
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="status1" value="izin" <?= ($anggota_absen['status'] == 'izin' ? 'checked' : ''); ?>>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="keterangan" name="keterangan" rows="3"><?= $anggota_absen['keterangan']; ?></textarea>
                    ...
                    <div class="col-lg-5 mt-4">
                        <img src="<?= base_url('layout') . '/img/ilustrasi/confirmation.png'; ?>" alt="Illustrations" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
